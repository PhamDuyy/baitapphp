...
<body>
    ...
    <form action="giai_pt_bac_2.php" method="post">
        <table width="805" border="1">
            ...
            <tr>
                <td width="85">Phương trình </td>
                <td width="230">
                    <input name="a" type="text" />
                    X^2 +
                </td>
                <td width="230"><label for="textfield1"></label>
                    <input type="text" name="b" id="textfield1" />
                    X +
                </td>
                <td width="230"><label for="textfield2"></label>
                    <input type="text" name="c" id="textfield2" />
                    = 0
                </td>
            </tr>
            <tr>
                <td colspan="4">
                    ...
                    <input name="" type="text" id="textfield3" size="60" value="<?php if (isset($nghiem)) echo $nghiem;?>" />
            </tr>
            <tr>
